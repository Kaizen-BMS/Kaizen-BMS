...
const TOKENS = {
  slip: [
    ...
    ["token", "Token number"], ["doctor", "Doctor (\"Doctor: Dr. …\")"], ["expected", "Expected time (\"Expected time: 10:40\")"], ["reason", "Reason for visit"], ["date", "Date"], ["time", "Time"], ["fee", "Fee paid"], ["footer", "Footer text (Branding)"],
  ],
  invoice: [
    ["facility", "Facility name"], ["address", "Address"], ["phone", "Facility phone"], ["gstin", "GSTIN"],
  ...
  slip: {
    parcha: {
      ...
      build: () => [
        ...
        T({ x: 8, y: 52, w: 60, text: "Phone: {phone_patient}", fontSize: 10 }),
        T({ x: 70, y: 52, w: 70, text: "{doctor}\n{expected}", fontSize: 9, align: "right" }),
        T({ x: 8, y: 64, w: 132, text: "Complaint: {reason}", fontSize: 10 }),
        LINE({ x: 8, y: 72, w: 132 }),
        T({ x: 8, y: 75, w: 20, text: "℞", fontSize: 30, bold: true }),
    ...
    boxed: {
      ...
      build: () => [
        ...
        T({ x: 8, y: 49, w: 132, text: "{doctor}   {expected}", fontSize: 9 }),
        T({ x: 8, y: 55, w: 132, text: "Date: {date}   Time: {time}", fontSize: 9, color: "#555555" }),
        T({ x: 8, y: 62, w: 132, text: "Reason: {reason}", fontSize: 10 }),
        LINE({ x: 8, y: 71, w: 132 }),
        T({ x: 8, y: 75, w: 20, text: "℞", fontSize: 28, bold: true }),
    ...
    compact: {
      ...
      build: () => [
        ...
        T({ x: 6, y: 55, w: 93, text: "{reason}", fontSize: 9, align: "center", color: "#555555" }),
        T({ x: 6, y: 61, w: 93, text: "{doctor}  {expected}", fontSize: 8, align: "center" }),
        LINE({ x: 6, y: 70, w: 93 }),
        T({ x: 6, y: 73, w: 93, text: "{date} {time}   Fee ₹{fee}", fontSize: 8, align: "center" }),
        T({ x: 6, y: 80, w: 93, text: "{footer}", fontSize: 7, align: "center", color: "#555555" }),
      ],
    },
    thermal: {
      ...
      build: () => [
        ...
        T({ x: 3, y: 64, w: 74, text: "{doctor}", fontSize: 9, bold: true, align: "center" }),
        T({ x: 3, y: 70, w: 74, text: "{expected}", fontSize: 9, align: "center" }),
        T({ x: 3, y: 76, w: 74, text: "Fee ₹{fee}", fontSize: 9, align: "center" }),
        T({ x: 3, y: 83, w: 74, text: "{footer}", fontSize: 7, align: "center" }),
      ],
    },
  },
  invoice: {
