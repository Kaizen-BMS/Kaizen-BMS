...
const WIDGETS = [
  ...
  { key: "radiology", title: "Radiology", category: "OPERATIONS", requiredModule: "RADIOLOGY", roles: ["HOSPITAL_ADMIN", "RADIOLOGY_STAFF"], tenantTypes: null, size: "medium" },
  ...
  { key: "workflows", title: "Workflows", category: "OPERATIONS", requiredModule: null, roles: ["HOSPITAL_ADMIN"], tenantTypes: ["HOSPITAL"], size: "medium" },
